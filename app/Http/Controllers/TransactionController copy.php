...
class TransactionController extends Controller
{
    ...
    public function createTransaction(Request $request){
        ...
        //     $data = collect($cartItems)->pluck(['quantity', 'price']);

        //     $detailOrdersData = [
        //         ['id_product' => 456, 'quantity' => 2, 'price' => 2000],
        //         ['id_product' => 789, 'quantity' => 1, 'price' => 1500],
        //     ];
        ...
        //    // $transaction->detailTransaction()->createMany($detailOrdersData);

        //     $transaction_detail = DetailTransaction::create([
        //         'id_product' => 1,
        //         'quantity' => 1,
        //         'price'=>1
        //     ]);
